...
beautiful.init("/home/joe/.config/awesome/zenburn/theme.lua")
...
tags = {
  names  = { "ma1n", "ma2l", "gam3", "d4d", "of5ice", "me6ia", "codin7", "8dmin", "a9lets" },
...
mytextclock = awful.widget.textclock({ align = "right" },"%I:%M:%S --  %m/%d/%y", 1)
...
globalkeys = awful.util.table.join(
    ...
    --awful.key({ modkey, "Control" }, "\",     function () dropdown('xterm') end),
